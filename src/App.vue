      ...
      <window class="hidden md:block" name="login" height="auto">
        <div class="flex flex-wrap p-8 bg-white dark:bg-gray-800 border dark:border-gray-500">
          ...
          <div class="w-1/2 mt-4 pr-2">
            <div class="flex border border-gray-200 dark:border-gray-500 hover:bg-gray-200 dark:hover:bg-gray-500 cursor-pointer p-2" @click="connectMetaMask()">
              <img
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(['theme', 'walletUsed', 'metaMaskLoggedIn', 'metaMaskAccount', 'metaMaskConnected'])
  },
  components: {
    Sidebar,
    Navbar,
