...
const ARB_CHEF_ABI = [{
    'inputs': [{
        ...
        'name': '_liquidityaddr',
        'type': 'address'
    }, {'internalType': 'address', 'name': '_comfundaddr', 'type': 'address'}, {
        'internalType': 'address',
        'name': '_founderaddr',
        'type': 'address'
        ...
        'name': '_userDepFee',
        'type': 'uint256'
    }, {'internalType': 'uint256', 'name': '_devDepFee', 'type': 'uint256'}, {
        'internalType': 'uint256[]',
        ...
        'type': 'uint256[]'
    }, {'internalType': 'uint256[]', 'name': '_blockDeltaEndStage', 'type': 'uint256[]'}, {
        'internalType': 'uint256[]',
        'name': '_userFeeStage',
        'type': 'uint256[]'
    }, {'internalType': 'uint256[]', 'name': '_devFeeStage', 'type': 'uint256[]'}],
    ...
    'inputs': [{'internalType': 'uint256', 'name': '_newFinish', 'type': 'uint256'}],
    ...
    'inputs': [{'internalType': 'address', 'name': '_newCom', 'type': 'address'}],
    'name': 'comUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
    ...
    'inputs': [{'internalType': 'address', 'name': '_newFounder', 'type': 'address'}],
    'name': 'founderUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
    ...
    'name': 'getPoolReward',
    'outputs': [{'internalType': 'uint256', 'name': 'forDev', 'type': 'uint256'}, {
        'internalType': 'uint256',
        'name': 'forFarmer',
        'type': 'uint256'
    }, {'internalType': 'uint256', 'name': 'forLP', 'type': 'uint256'}, {
        'internalType': 'uint256',
        'name': 'forCom',
        'type': 'uint256'
    }, {'internalType': 'uint256', 'name': 'forFounders', 'type': 'uint256'}],
    'stateMutability': 'view',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'address', 'name': '_user', 'type': 'address'}, {
    ...
    'inputs': [],
    'name': 'govToken',
    'outputs': [{'internalType': 'contract GovernanceToken', 'name': '', 'type': 'address'}],
    'stateMutability': 'view',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256[]', 'name': '_newHalving', 'type': 'uint256[]'}],
    'name': 'halvingUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
    ...
    'inputs': [{'internalType': 'uint256', 'name': '_newcomlock', 'type': 'uint256'}],
    'name': 'lockcomUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '_newdevlock', 'type': 'uint256'}],
    'name': 'lockdevUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '_newfounderlock', 'type': 'uint256'}],
    'name': 'lockfounderUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '_newlplock', 'type': 'uint256'}],
    'name': 'locklpUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'address', 'name': '_newLP', 'type': 'address'}],
    'name': 'lpUpdate',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
    ...
    'inputs': [{'internalType': 'uint256[]', 'name': '_newMulReward', 'type': 'uint256[]'}],
    ...
    'inputs': [{'internalType': 'uint256', 'name': '_devDepFees', 'type': 'uint256'}],
    'name': 'setDevDepFee',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256[]', 'name': '_devFees', 'type': 'uint256[]'}],
    'name': 'setDevFeeStage',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256[]', 'name': '_blockEnds', 'type': 'uint256[]'}],
    'name': 'setStageEnds',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256[]', 'name': '_blockStarts', 'type': 'uint256[]'}],
    'name': 'setStageStarts',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '_usrDepFees', 'type': 'uint256'}],
    'name': 'setUserDepFee',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256[]', 'name': '_userFees', 'type': 'uint256[]'}],
    'name': 'setUserFeeStage',
    'outputs': [],
    'stateMutability': 'nonpayable',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '_newstarblock', 'type': 'uint256'}],
    ...
    'inputs': [{'internalType': 'address', 'name': '', 'type': 'address'}],
    'name': 'userGlobalInfo',
    'outputs': [{'internalType': 'uint256', 'name': 'globalAmount', 'type': 'uint256'}, {
        'internalType': 'uint256',
        'name': 'totalReferals',
        'type': 'uint256'
    }, {'internalType': 'uint256', 'name': 'globalRefAmount', 'type': 'uint256'}],
    'stateMutability': 'view',
    'type': 'function'
}, {
    'inputs': [{'internalType': 'uint256', 'name': '', 'type': 'uint256'}, {
    ...
    'outputs': [{'internalType': 'uint256', 'name': 'amount', 'type': 'uint256'}, {
        ...
        'type': 'uint256'
    }, {'internalType': 'uint256', 'name': 'firstDepositBlock', 'type': 'uint256'}, {
        'internalType': 'uint256',
        'name': 'blockdelta',
        'type': 'uint256'
