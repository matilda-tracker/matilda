<template>
  <div class="sticky top-0 z-40">
    <div class="w-full h-20 px-6 bg-gray-100 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
      ...
      <div class="flex w-full">
        ...
        <div class="inline-block lg:hidden flex items-center mr-4">
          <button class="hover:text-blue-500 hover:border-white focus:outline-none navbar-burger"
                  @click="toggleSidebar()">
            <svg class="h-5 w-5" :class="`hamburger-color-${theme}`" viewBox="0 0 20 20"
