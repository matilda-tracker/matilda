            ...
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <div class="relative text-gray-600">
                  <input type="search" name="search" placeholder="Look up token by address..." class="bg-white h-10 w-full xl:w-96 px-5 rounded-lg border text-sm focus:outline-none">
