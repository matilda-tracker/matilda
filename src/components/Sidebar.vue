<template>
  ...
  <div
      class="w-2/3 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-30"
